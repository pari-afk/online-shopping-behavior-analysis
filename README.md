...
. ├── src/ │ └── main.py ├── data/ │ ├── online_shoppers_intention.csv │ └── Online Shopping Behaviour 2.csv ├── figures/ │ ├── uci_pca_clusters.png │ └── survey_pca_clusters.png ├── report.pdf ├── requirements.txt └── README.md
